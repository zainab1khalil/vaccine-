...
// Real WhatsApp API test for employee 2182 with actual credentials
...
echo "=== Real WhatsApp API Test for Employee 2182 ===\n\n";
...
if ($httpCode === 200) {
    echo "✅ SUCCESS: WhatsApp message sent successfully to employee 2182!\n";
